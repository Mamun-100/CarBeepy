...
const CarDetails = ({props,route}) => {
    ...
    return (
        <View style={styles.container}>
            <View><Header title={carT}/></View>
            <View style={{marginVertical: '10%'}}>
                <Image source={imgBody} style={{width: 380,height: 230, justifyContent: 'center', alignSelf: 'center'}} />
            </View>
            

             <View style={{ width: '100%', height: '100%',backgroundColor: colors, borderRadius: 30,marginTop: 10,}}>
                 <View style={styles.title}>
                     <Text style={{fontSize: 40, color: '#fff'}}>{carT}</Text>
                     <Image source={require('../assets/img/car_card/Star.png')} style={{width: 30, height: 30}}/>
                 </View>
                 ...
                 <View style={{marginVertical: '10%', paddingHorizontal: '5%'}}>
                     <Text style={{color: '#fff', fontSize: 20, fontWeight: '600'}}>Description:</Text>
                     <Text style={{color: '#fff', fontSize: 18, paddingTop: 10, lineHeight: 28}}>{description}</Text>
                 </View>
                 <View style={{width: '90%', justifyContent: 'center', alignSelf: 'center'}}>
                     <TouchableOpacity 
                     style={{backgroundColor: '#fff', borderRadius: 10,height: 55,alignItems: 'center', justifyContent: 'center'}}
