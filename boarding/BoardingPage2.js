...
const BoardingPage2 = ({navigation}) => {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.imgView}>
                <Image source={require('../assets/img/b_page/boardingPage2.png')}
            ...
            <View style={styles.textView}>
                <Text style={styles.boldText}>Your dream Car</Text>
                <Text style={styles.normalText}>Rent the car you've always wanted to drive.</Text>
            </View>

            <View style={styles.btnView}>
                <TouchableOpacity style={styles.btnTouch}
                onPress={()=>navigation.navigate('BoardingPage3')}
                >
