...
const BoardingPage4 = ({navigation}) => {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.imgView}>
                <Image source={require('../assets/img/b_page/boardingPage4.png')}
            ...
            <View style={styles.textView}>
                <Text style={styles.boldText}>Find Our Stations!</Text>
                <Text style={styles.normalText}>Find your nearest station to rent your car!</Text>
            </View>
